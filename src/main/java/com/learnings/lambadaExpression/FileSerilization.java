package com.learnings.lambadaExpression;// Java Program to serialize and deserialize the lambda
...
public class FileSerilization {
		...
		throws Exception
	{
		...
		serialize(HelloImpl.class, path);
		...
		HelloInterface instance
			= (HelloInterface)myImplClass.newInstance();
		instance.hello("Java");
	}
