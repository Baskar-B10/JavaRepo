package com.program.file.basicOperation;// Java program to read and print all files
// from a zip file
...
public class ReadAndPrintFromZipFiles {
	...
	public static void main(String[] args)
	{
		...
		ReadAndPrintFromZipFiles zf = new ReadAndPrintFromZipFiles();
