package com.program.list.remove;// Java code to remove a subList
...
public class RemoveSubListUsingRange extends ArrayList<Integer> {
	...
	{ 
		...
		RemoveSubListUsingRange arr = new RemoveSubListUsingRange();
