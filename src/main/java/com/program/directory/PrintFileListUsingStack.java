package com.program.directory;// Iterative Program to get all file names in Directory and
// SubDirectory

import java.io.*;
import java.util.Stack;

class PrintFileListUsingStack {
	public static void main(String[] args)
	{
		// provide complete path for directory(to be changed
		// accordingly)
		String mainDir = "C:\\Users\\Admin\\Desktop\\demo\\src\\main\\java\\com\\program";
		// File object
