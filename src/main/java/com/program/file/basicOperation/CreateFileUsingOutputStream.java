package com.program.file.basicOperation;// Java Program to create new file
...
public class CreateFileUsingOutputStream {
	...
	public static void main(String args[])
	{
		...
		CreateFileUsingOutputStream createFileUsingOutputStream = new CreateFileUsingOutputStream();
		createFileUsingOutputStream.newFile();
	}
