package com.program.exceptions.runTime;// Java Program to Demonstrate Exception is Thrown
...
class RunTimeExceptionExample {
    ...
    // Method 1
    // It throws the Exception(ArithmeticExceptionExample).
    // Appropriate Exception handler is not found
    // within this method.
    static int divideByZero(int a, int b)
    {

        // this statement will cause ArithmeticExceptionExample
        // (/by zero)
        int i = a / b;
    ...
    public static void main(String args[])
    {
        ...
        // Catch block to handle ArithmeticExceptionExample
        // exceptions
