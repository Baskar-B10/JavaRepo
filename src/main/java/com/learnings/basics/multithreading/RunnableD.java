package com.learnings.basics.multithreading;// Java Program to illustrate Runnable Interface in threads
...
public class RunnableD {
    ...
    public static void main(String[] args)
    {
        ...
        Runnable obj1 = new MyThread7();
        Runnable obj2 = new MyThread8();
